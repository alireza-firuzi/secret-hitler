...
class _GameBoardScreenState extends State<GameBoardScreen> {
  ...
  void _onEngineChange() {
    ...
    if (currentPhase != _lastPhase) {
      ...
      if (oldPhase == GamePhase.electionVoting) {
      ...
      if (currentPhase == GamePhase.executiveAction && widget.engine.activePower == ExecutivePower.execution) {
